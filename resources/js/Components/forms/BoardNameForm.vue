...
<template>
    <div class="flex flex-col items-start max-w-full relative">
        <h1
            ...
            class="hover:bg-white/20 whitespace-pre w-full overflow-hidden text-ellipsis border border-transparent rounded-md cursor-pointer px-3 py-1.5 text-xl text-blackfont-bold"
            @click="edit()"
